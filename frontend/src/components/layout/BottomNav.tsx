...
const NAV_ITEMS = [
  ...
  { to: "/scholarships/search", label: "Scholarships", icon: "M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" },
          ...
          return (
            <li key={item.to} className="flex-1">
              <Link
                ...
                className={cn(
                  "focus-visible-ring flex min-h-[56px] flex-col items-center justify-center gap-1 px-2 py-2 text-xs font-medium transition duration-fast",
