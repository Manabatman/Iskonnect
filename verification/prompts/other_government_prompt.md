# ISKONNECT Verification — Other national government programs

**Bundle ID:** `other_government`

## Before you start

1. Paste `verification/prompts/00_MASTER_INSTRUCTIONS.md` into this conversation first.
2. Attach `verification/export/bundles/other_government.json` (generated export).
3. Enable web search.
...
Scholarship IDs in this export: 17, 20, 55
...
```
verification/reports/other_government/
  human_report.md
  field_changes.csv
