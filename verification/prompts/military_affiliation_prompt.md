# ISKONNECT Verification — Military / uniformed service affiliation

**Bundle ID:** `military_affiliation`

## Before you start

1. Paste `verification/prompts/00_MASTER_INSTRUCTIONS.md` into this conversation first.
2. Attach `verification/export/bundles/military_affiliation.json` (generated export).
3. Enable web search.
...
Scholarship IDs in this export: 56, 62
...
- AFPSLAI Educational Grant
- AFPEBSO DND CHED PASUC
...
```
verification/reports/military_affiliation/
  human_report.md
  field_changes.csv
