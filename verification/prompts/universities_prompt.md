# ISKONNECT Verification — Universities and colleges

**Bundle ID:** `universities`

## Before you start

1. Paste `verification/prompts/00_MASTER_INSTRUCTIONS.md` into this conversation first.
2. Attach `verification/export/bundles/universities.json` (generated export).
3. Enable web search.

## Scope

Verify **only** scholarships in this bundle export (7 records).

Scholarship IDs in this export: 18, 23, 24, 40, 41, 45, 69
...
```
verification/reports/universities/
  human_report.md
  field_changes.csv
