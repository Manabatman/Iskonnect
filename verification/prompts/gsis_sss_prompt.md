# ISKONNECT Verification — GSIS + SSS
...
2. Attach `verification/export/bundles/gsis_sss.json` (generated export).
3. Enable web search.
...
Scholarship IDs in this export: 7, 8, 78
