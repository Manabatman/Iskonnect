# ISKONNECT Verification — International scholarships

**Bundle ID:** `international`

## Before you start

1. Paste `verification/prompts/00_MASTER_INSTRUCTIONS.md` into this conversation first.
2. Attach `verification/export/bundles/international.json` (generated export).
3. Enable web search.
...
Scholarship IDs in this export: 63, 91
...
```
verification/reports/international/
  human_report.md
  field_changes.csv
