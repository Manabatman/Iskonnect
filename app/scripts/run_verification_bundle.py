    ...
    report_path.write_text(
        "\n".join(
            [
                ...
                "Full provider verification (eligibility, dates, benefits) requires",
                "a manual review workflow against official provider sources.",
                "",
                "## Link audit summary",
                "",
                ...
                "## Next steps",
                "",
                "1. Review each scholarship against its official provider page.",
