...
const Sheet = ({ ...props }: SheetProps) => <DialogPrimitive.Root {...props} />;
...
const sheetSideClasses: Record<NonNullable<SheetProps["side"]>, string> = {
...
const SheetContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content> & { side?: SheetProps["side"] }
>(({ side = "right", className, children, ...props }, ref) => (
  <SheetPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed z-50 gap-4 bg-background p-6 shadow-3 transition ease-in-out data-[state=closed]:duration-base data-[state=open]:duration-overlay",
